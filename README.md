...
- Supports Team Access assignment profiles, app-area preferences, in-app notifications with dismiss/read controls, and optional email notifications.
...
- Team member user IDs are assignment profiles today, not separate production logins. Production login is still controlled by Vercel `OWNER_ACCESS_CODE` until real server-side team auth is added.
